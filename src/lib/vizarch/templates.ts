...
export const TEMPLATES: ArchTemplate[] = [
  ...
  },
  {
    ...
    description: "CDN → Load Balancer → Microservices → DB + Cache + Search + Payments",
    text:
      "React storefront, CloudFront CDN, Load Balancer, Product service, Cart service, Order service, PostgreSQL, Redis cache, Elasticsearch search, Stripe payments, S3 assets, CloudWatch",
    nodes: [
      { id: "n1", service: "generic.frontend", label: "Storefront" },
      { id: "n2", service: "aws.cloudfront", label: "CloudFront" },
      { id: "n3", service: "aws.elb", label: "Load Balancer" },
      { id: "n4", service: "generic.microservice", label: "Product Service" },
      { id: "n5", service: "generic.microservice", label: "Cart Service" },
      { id: "n6", service: "generic.microservice", label: "Order Service" },
      { id: "n7", service: "generic.postgres", label: "PostgreSQL" },
      { id: "n8", service: "generic.redis", label: "Redis Cache" },
      { id: "n9", service: "generic.elasticsearch", label: "Elasticsearch" },
      { id: "n10", service: "generic.stripe", label: "Stripe Payments" },
      { id: "n11", service: "aws.s3", label: "S3 Assets" },
      { id: "n12", service: "aws.cloudwatch", label: "CloudWatch" },
    ],
    edges: [
      { from: "n1", to: "n2", protocol: "https" },
      { from: "n2", to: "n3", protocol: "https" },
      { from: "n3", to: "n4", protocol: "https" },
      { from: "n3", to: "n5", protocol: "https" },
      { from: "n3", to: "n6", protocol: "https" },
      { from: "n4", to: "n7", protocol: "postgres", label: "Products" },
      { from: "n5", to: "n8", protocol: "redis", label: "Cart cache" },
      { from: "n6", to: "n7", protocol: "postgres", label: "Orders" },
      { from: "n4", to: "n9", protocol: "https", label: "Search" },
      { from: "n6", to: "n10", protocol: "https", label: "Charge" },
      { from: "n1", to: "n11", protocol: "https", label: "Assets" },
      { from: "n6", to: "n12", protocol: "direct", label: "Metrics" },
    ],
  },
  {
    id: "iot-platform",
    name: "IoT Platform",
    description: "Devices → IoT Core → Kinesis → Lambda → DynamoDB + S3 + SNS",
    text:
      "IoT devices, AWS IoT Core, Kinesis data stream, Lambda processor, DynamoDB device state, S3 raw data, SNS alerts, Elasticsearch analytics, Grafana dashboards",
    nodes: [
      { id: "n1", service: "aws.iot", label: "IoT Devices" },
      { id: "n2", service: "aws.iot", label: "IoT Core" },
      { id: "n3", service: "aws.kinesis", label: "Kinesis Stream" },
      { id: "n4", service: "aws.lambda", label: "Processor Lambda" },
      { id: "n5", service: "aws.dynamodb", label: "DynamoDB State" },
      { id: "n6", service: "aws.s3", label: "S3 Raw Data" },
      { id: "n7", service: "aws.sns", label: "SNS Alerts" },
      { id: "n8", service: "generic.elasticsearch", label: "Elasticsearch" },
      { id: "n9", service: "generic.grafana", label: "Grafana" },
    ],
    edges: [
      { from: "n1", to: "n2", protocol: "mqtt", label: "MQTT" },
      { from: "n2", to: "n3", protocol: "event", label: "Stream" },
      { from: "n3", to: "n4", protocol: "event", label: "Process" },
      { from: "n4", to: "n5", protocol: "db", label: "State" },
      { from: "n4", to: "n6", protocol: "https", label: "Archive" },
      { from: "n4", to: "n7", protocol: "event", label: "Alerts" },
      { from: "n4", to: "n8", protocol: "https", label: "Index" },
      { from: "n8", to: "n9", protocol: "direct", label: "Visualize" },
    ],
  },
  {
    id: "web3-blockchain",
    name: "Web3 / Blockchain",
    description: "dApp → IPFS → Smart Contract → RPC Node → Indexer → Graph",
    text:
      "React dApp frontend, IPFS storage, Ethereum smart contract, RPC node, The Graph indexer, Redis cache, PostgreSQL event log, Metamask wallet, Cloudflare CDN",
    nodes: [
      { id: "n1", service: "generic.frontend", label: "dApp Frontend" },
      { id: "n2", service: "generic.cloudflare", label: "Cloudflare CDN" },
      { id: "n3", service: "aws.s3", label: "IPFS Gateway" },
      { id: "n4", service: "generic.microservice", label: "Smart Contract" },
      { id: "n5", service: "generic.api", label: "RPC Node" },
      { id: "n6", service: "generic.microservice", label: "Graph Indexer" },
      { id: "n7", service: "generic.redis", label: "Redis Cache" },
      { id: "n8", service: "generic.postgres", label: "Event Log" },
      { id: "n9", service: "generic.stripe", label: "Metamask" },
    ],
    edges: [
      { from: "n1", to: "n2", protocol: "https" },
      { from: "n2", to: "n3", protocol: "https", label: "IPFS" },
      { from: "n1", to: "n9", protocol: "https", label: "Wallet" },
      { from: "n9", to: "n4", protocol: "https", label: "Sign tx" },
      { from: "n4", to: "n5", protocol: "https", label: "RPC" },
      { from: "n5", to: "n6", protocol: "event", label: "Index events" },
      { from: "n6", to: "n7", protocol: "redis", label: "Cache" },
      { from: "n6", to: "n8", protocol: "postgres", label: "Log" },
    ],
  },
];
